/**
 * AHL AL-QURAN — main.js
 * All interactive logic for the Quran Competition landing page.
 *
 * Modules:
 ...
 *  5. Scroll Animations — IntersectionObserver reveal
 *  6. Modal System — open/close, focus trap, ARIA
 *  7. Registration Form — validation, loading state, submit
 *  8. Toast Notifications — show/dismiss
 *  9. Button Wiring — connect all CTA buttons
 * 10. Download Guide — mock download handler
 */
